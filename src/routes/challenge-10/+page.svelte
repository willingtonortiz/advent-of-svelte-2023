...
<main class="mt-4">
  ...
  <ChallengeTitle>Challenge 10 - Day 10 - Pop-up! Spreading the holiday cheer</ChallengeTitle>
    ...
    <Dialog.Root open={isOpen} onOpenChange={(open) => (isOpen = open)}>
      <Dialog.Content class="bg-[#f2f5ed]">
        ...
        <p class="text-center font-semibold">
          Greetings, Svelte Developer! Wishing your code be as smooth as fresh snow and your
          Christmas be filled with magic and joy. Keep coding and spreading cheer! 🎄🚀
        </p>
      </Dialog.Content>
    </Dialog.Root>
  </div>
